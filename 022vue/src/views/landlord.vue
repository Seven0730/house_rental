    ...
    <div>
        ...
        <div class="new-wrap">
            ...
            <div class="pic_grid app_width">
                <el-input placeholder="房东搜索" v-model="listQuery.keyword" style="width: 350px;">
            ...
            <div class="pic_grid app_width">
                <div v-for="(item,index) of landlords"

                     :key="index">


                    <div class="icon-item">
                        <router-link :to="'/landlordDetail?id='+item.landlordid">
...
function getList() {
    ...
    axios_request.get('/web/landlord.action', {params: listQuery.value}).then(response => {
        landlords.value = null
        landlords.value = response.data.landlordList
