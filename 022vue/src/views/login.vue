    ...
    <div class="pc-login-bj">
        <div class=" pc-login-box_aa">
            <div class=" pc-login-box">
                ...
                <el-form status-icon :model="loginForm" :rules="loginRules" ref="postFormRef"          label-width="1px"
                >
...
onMounted(() =>
 {
            ...
            function handleLogin(){
                ...
                postFormRef.value.validate(valid => {
                    if (valid) {
                        loading.value = true
                        store.dispatch('SetStoreLoginByusername_web', loginForm.value).then(response => {
