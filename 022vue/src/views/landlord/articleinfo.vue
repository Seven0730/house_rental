                ...
                <el-card>
                    ...
                    <div class="app-container">
                        ...
                        >
                            ...
                            <el-table-column align="center" header-align="center" label="点击数">
                                <template #default="scope">
                                    {{ scope.row.hits }}
                                </template>
                            </el-table-column>
...
import {ElMessage,ElMessageBox} from "element-plus";  //提示框和消息
    ...
    import dialogForm from './articleinfo_form_components'
            ...
            getList()
             ...
             function getList() {
                ...
                listLoading.value = true
                            axios_request.get('/webarticle/getAll.action',{                params: listQuery.value            }).then(response => {
            ...
            function handleDelete(scope){
                ElMessageBox.confirm("确定要进行此操作吗?", "提示").then(() => {
                    ...
                    const id = scope.row.articleid
                    		axios_request.post('/webarticle/delete.action?id='+id).then(response => {
                        ElMessage({
