    ...
    <div>
        ...
        <div class="app-container">
            ...
            >
                ...
                <el-table-column align="center" header-align="center" label="用户">
                ...
                <el-table-column align="center" label="操作" width="300">
                    <template #default="scope">
                        ...
                        <el-button v-if="scope.row.status!='取消'" text size="small"
...
function getList() {
    ...
    axios_request.get('/web/getLandlordOrders.action' ).then(response => {
...
function handleOver(scope, status) {
    ElMessageBox.confirm("确定要进行此操作吗?", "提示").then(() => {
        ...
        axios_request.get('/web/over.action?id=' + id + '&status=' + status).then(response => {
            ElMessage({
