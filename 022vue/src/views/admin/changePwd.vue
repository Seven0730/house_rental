<template>
    <div>
        <el-form status-icon :model="pwdForm" :rules="pwdRules" ref="postFormRef"          label-width="100px">
             ...
             function saveData() {
                ...
                postFormRef.value.validate(valid => {
                    ...
                    if (valid) {
                        ...
                        axios_request.post('/admin/admin/editpwd.action', pwdForm.value).then(response => {
